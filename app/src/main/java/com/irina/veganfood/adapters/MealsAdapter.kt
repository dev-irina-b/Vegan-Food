...
class MealsAdapter(private val mealType: Int, private val context: Context, private val callback: () -> Unit) : RecyclerView.Adapter<MealsAdapter.ViewHolder>(){
    ...
    companion object {
        ...
        val hotMeals = listOf(
            ...
            Meal("Fresh vegetables with sweet potato", "$3", "200g", "Sweet potatoes, soybean oil, black pepper, paprika, garlic powder, radish, coriander, pickles", "357", "9.6", "15.4", "84", R.drawable.fresh_vegetables_with_sweet_potato_fries),
            ...
            Meal("Couscous with vegetables", "$2", "250g", "Olive oil, red onion, bell pepper, carrot, garlic, paprika, coriander, peas, couscous, broccoli", "472", "17", "10", "77", R.drawable.cous_cous_with_vegetables_in_a_pan),
            Meal("Oatmeal with chia seeds", "$2", "250g", "Oats, chia seeds, banana, walnuts, oat milk", "340", "6", "6", "30", R.drawable.oatmeal_with_chia_seeds_banana_and_walnuts),
            Meal("Banana oatmeal with blueberries", "$5", "250g", "Oats, oat milk, banana, blueberries, chocolate and apple, vanilla", "309", "6.3", "4.5", "32", R.drawable.banana_oatmeal_with_blueberries_chocolate_and_apple),
            Meal("Cereals bowl with raspberries", "$5", "250g", "Almonds, walnut, peanut, hazelnut, almond milk, raspberries", "330", "15", "20", "80", R.drawable.cereals_bowl_with_frozen_raspberries_and_nuts)
        ...
        val soups = listOf(
            ...
            Meal("Mixed carrot soup with veggies", "$2", "250g", "Olive oil, onion, celery, garlic, ginger, lime, cumin, turmeric, coriander, carrot, potato", "161", "5", "3", "32", R.drawable.mixed_carrot_soup_with_veggies),
        ...
        val pasta = listOf(
            ...
            Meal("Noodles with mushroom", "$4", "250g", "Olive oil, onion, red pepper, green pepper, carrot, mushroom, ginger, soy sauce, sesame seeds, udon noodles", "334", "14", "6", "65", R.drawable.noodles)
        ...
        val pizza = listOf(
            ...
            Meal("Special pizza", "$6", "250g", "Dough, tomato sauce, vegan cheese, garlic oil, oregano, red pepper, basil", "350", "10", "5", "64", R.drawable.pizza),
